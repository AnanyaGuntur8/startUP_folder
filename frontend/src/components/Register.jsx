    ...
    <div className="login-shell">
      ...
      <div className="blueprint-pane">
        <svg viewBox="0 0 600 600" className="blueprint-svg" aria-hidden>
          ...
          <rect
            x="120" y="280" width="60" height="220"
            fill="none" stroke="white" strokeWidth="0.4" opacity="0.5"
          />
          <rect
            x="420" y="250" width="80" height="250"
            fill="none" stroke="white" strokeWidth="0.4" opacity="0.5"
          />

          {/* Ground line (static) */}
          <line
            x1="70" y1="500" x2="550" y2="500"
          ...
          {/* Subtle vertical dashed guide lines (static like Login page) */}
          <g opacity="0.2">
